...
describe 'Integration test for the DeleteSuggestion service and API gateway' do
  it 'must create a new inbox' do
    ...
    params = MindMap::Forms::DeleteSuggestion.new.call({ inbox_id: inbox_id,
                                                         suggestion_id: suggestion_id.to_s })

    result = MindMap::Service::DeleteSuggestion.new.call(params)
